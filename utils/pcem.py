...
def run_PCEM(spath = None, dpath = None):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run PCEM preprocessing")
    parser.add_argument("--spath", type=str, required=True, help="Source image folder path")
    parser.add_argument("--dpath", type=str, required=True, help="Destination save folder path")

    args = parser.parse_args()

    run_PCEM(spath=args.spath, dpath=args.dpath)